...
public class EditProductActivity extends Activity {
    ...
    private static final String url_product_details = "http://phoneshop.daulab.org/phoneshop/get_product_detail/";

    // адрес для обновления базы данных
    private static final String url_update_product = "http://phoneshop.daulab.org/phoneshop/update_product/";

    // адрес для удаления из базы данных
    private static final String url_delete_product = "http://phoneshop.daulab.org/phoneshop/delete_product/";
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    Log.d("ПРОВЕРКА", "Не получилось обновить товар") ;
                }
            } catch (JSONException e) {
                e.printStackTrace();
            }
